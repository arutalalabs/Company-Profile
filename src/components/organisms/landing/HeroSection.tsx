            ...
            <div className="relative bg-[var(--color-neutral-950)] w-full min-h-[614px] flex justify-center items-center overflow-hidden sm:rounded-2xl sm:min-h-[520px] md:min-h-[580px] lg:min-h-[480px] 2xl:min-h-[614px] lg:rounded-3xl">
                ...
                <div className="absolute inset-0 pointer-events-none overflow-hidden">
                    ...
                    <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 animate-[pulse_5s_ease-in-out_infinite]">
                        {/* Outer soft glow */}
                        <div className="w-64 h-64 sm:w-60 sm:h-60 lg:w-[380px] lg:h-[380px] 2xl:h-[300px] bg-blue-600/30 rounded-full blur-3xl" />
                        {/* Middle glow */}
                        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-40 h-40 sm:w-52 sm:h-52 lg:w-56 lg:h-56 2xl:w-64 2xl:h-64 bg-blue-900/10 rounded-full blur-3xl" />
                        {/* Inner bright core */}
                        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-20 h-20 sm:w-28 sm:h-28 lg:w-30 lg:h-30 2xl:w-36 2xl:h-36 bg-blue-800/10 rounded-full blur-3xl" />
                    </div>
                </div>
