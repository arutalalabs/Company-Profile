...
export default function HeroSection() {
    return (
        <section className="bg-[#ffffff] w-full sm:px-4 sm:pt-2 lg:pt-6 lg:px-8 ">
            <div className="relative bg-[var(--color-neutral-950)] w-full min-h-[614px] flex justify-center items-center overflow-hidden sm:rounded-2xl sm:min-h-[520px] md:min-h-[580px] lg:rounded-3xl lg:min-h-[614px]">
                {/* Background Animations Layer */}
                <div className="absolute inset-0 pointer-events-none overflow-hidden">
                    {/* Star Glow - Top Right */}
                    <div className="absolute top-4 right-4 sm:top-2 sm:right-2 lg:top-8 lg:right-8 2xl:top-10 2xl:right-12 w-40 h-40 sm:w-56 sm:h-56 lg:w-64 lg:h-64 animate-[pulse_4s_ease-in-out_infinite]">
                    ...
                    <div className="absolute bottom-4 left-4 sm:bottom-2 sm:left-2 lg:bottom-8 lg:left-8 2xl:bottom-10 2xl:left-12 w-40 h-40 sm:w-56 sm:h-56 lg:w-64 lg:h-64 animate-[pulse_4s_ease-in-out_infinite_2s]">
                        {/* Vertical beam - tall and narrow */}
                        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-4 sm:w-6 lg:w-8 h-full bg-gradient-to-b from-transparent via-blue-900/80 to-transparent blur-md" />
                        {/* Horizontal beam - wide and short */}
                        <div className="absolute top-1/2 left-0 -translate-y-1/2 w-full h-4 sm:h-6 lg:h-8 bg-gradient-to-r from-transparent via-blue-900/80 to-transparent blur-md" />
