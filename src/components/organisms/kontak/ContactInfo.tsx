        ...
        <div className="space-y-4">
            ...
            <div className="space-y-4">
                <Typography
                    ...
                    weight="bold"
                    color="neutral-950"
                    className="leading-tight lg:text-3xl"
                >
                    Kontak Kami
                </Typography>
                <Typography
                    ...
                    color="neutral-600"
                    leading="relaxed"
                    className="max-w-md lg:text-base"
                >
                    Kami selalu memprioritaskan kebutuhan dan menjawab semua pertanyaan anda. Hubungi kami melalui email atau WhatsApp,
                    atau isi form di samping untuk mengirimkan pesan.
                </Typography>
            </div>
